...
import { useStore } from 'vuex' // global variables
...
export default{
    ...
    setup(){
        ...
        let socket = null;
        onMounted(() => {//Executed when the current component is mounted (the current page is opened):
            ...
            socket.onmessage = msg => {
                const data = JSON.parse(msg.data); //Data format defined by Spring: data
